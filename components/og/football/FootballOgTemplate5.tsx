...
// ============================================================================
// 5. THE STATEMENT QUOTE / FULL-SCREEN HERO IMAGE & FROSTED GLASS CENTER
// ============================================================================
export function FootballOgTemplate5({
    teamName,
    siteName,
    title,
    snippet,
    ...
    return (
        ...
        >
            ...
            <div style={{ display: "flex", position: "absolute", top: 0, left: 0, width: "1080px", height: "1350px" }}>
                ...
                />
                {/* Team Primary Color Ambient Light */}
                <div
                    style={{
                        display: "flex",
                        position: "absolute",
